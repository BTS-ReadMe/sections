...
//
//    @Bean
//    public ProducerFactory<String, RequestKafkaNovelCards> msgProducerFactory() {
...
//
//    @Bean
//    public KafkaTemplate<String, RequestKafkaNovelCards> msgKafkaTemplate(){
//        return new KafkaTemplate<String, RequestKafkaNovelCards>(msgProducerFactory());
//    }
//
//    @Bean
...
//        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(RequestNovelCards.class));
//    }
//
//    @Bean
